...
from alter_sdk import (
    ...
    ProviderAPIError, ScopeReauthRequiredError,
...
|---|---|
| `GrantRevokedError`, `CredentialRevokedError`, `GrantNotFoundError`, `TokenRefreshInProgressError`, `ScopeReauthRequiredError` | `grant_id`, sometimes `provider_id`, `agent_id`, `app_user_id` |
...
| `ProviderAPIError`, `ScopeReauthRequiredError` | `status_code`, `response_body` |
