...
- `NoDelegatedGrantError` — the calling agent has no delegation for the resolved user on this provider. Recoverable via [`createConnectSessionForError()`](/reference/typescript-sdk/connect#createconnectsessionforerror).
