...
The return type of [`request()`](/reference/typescript-sdk/request).
...
Returned by [`listGrants()`](/reference/typescript-sdk/grants#listgrants).
...
Discriminated union passed to [`createManagedSecretGrant()`](/reference/typescript-sdk/grants#createmanagedsecretgrant).
...
Returned by [`createManagedSecretGrant()`](/reference/typescript-sdk/grants#createmanagedsecretgrant).
...
Returned by [`revokeGrant()`](/reference/typescript-sdk/grants#revokegrant).
...
Returned by [`createConnectSession()`](/reference/typescript-sdk/connect#createconnectsession).
...
Returned by [`createManagedSecretConnectSession()`](/reference/typescript-sdk/connect#createmanagedsecretconnectsession). Same shape as `ConnectSession`.

`toString()` redacts `connectUrl` — the URL fragment carries the session token, so logging would be a leak.

## ConnectResult

Returned per provider by [`connect()`](/reference/typescript-sdk/connect#connect) and [`pollConnectSession()`](/reference/typescript-sdk/connect#pollconnectsession).
...
Returned by [`authenticate()`](/reference/typescript-sdk/connect#authenticate).
...
Returned by [`proxyRequest()`](/reference/typescript-sdk/proxy) when an HITL grant requires approval.
...
Snapshot returned by [`getApprovalStatus()`](/reference/typescript-sdk/approvals#getapprovalstatus).
...
Returned by [`awaitApproval()`](/reference/typescript-sdk/approvals#awaitapproval) and the synchronous branch of [`proxyRequest()`](/reference/typescript-sdk/proxy).
...
Returned by [`scopes.list()`](/reference/typescript-sdk/scopes#list).
