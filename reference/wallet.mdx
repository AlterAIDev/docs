...
description: 'End-user transparency and control over OAuth grants and agent activity'
---

## Overview

The Wallet Dashboard is the end-user-facing interface where the people whose credentials are stored in Alter Vault can see and control how those credentials are being used. End users access the Wallet at [wallet.alterauth.com](https://wallet.alterauth.com).
...
<Info>
  Interested in end-user policies? [Contact the team](mailto:founders@alterauth.com) to discuss early access.
</Info>
