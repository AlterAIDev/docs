...
5. **Injection.** The token is injected as a header on the outgoing provider request (`Authorization: Bearer …` by default; the [managed-secret](/concepts/managed-secrets) configuration controls the exact format).
