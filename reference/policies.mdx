...
App-level policies apply to **all connections** for a given provider within your app. Configure them in the Developer Portal under **Policies**.
...
| Rule | Description |
|------|-------------|
| **Business hours only** | 9:00 AM – 5:00 PM in your configured timezone |
...
<Steps>
  <Step title="Open your app in the Developer Portal">
    Go to [portal.alterai.dev](https://portal.alterai.dev) and select your app
  </Step>
...
<AccordionGroup>
  <Accordion title="Start permissive, tighten gradually" icon="chart-line">
    Enable audit logging first to understand your access patterns. Then add policies based on actual usage — this avoids accidentally blocking legitimate access.
  </Accordion>
  ...
  <Accordion title="Match timezone to your team" icon="globe">
    Set the policy timezone to match where your team operates. If you have distributed teams, consider using UTC and broader time windows.
  </Accordion>
</AccordionGroup>
