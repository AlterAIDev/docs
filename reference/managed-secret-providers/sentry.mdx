...
<Steps>
  ...
  <Step title="Go to Settings → Account → API → Auth Tokens">
    Go to Settings → Account → API → Auth Tokens at [sentry.io/settings/account/api/auth-tokens/](https://sentry.io/settings/account/api/auth-tokens/).
  </Step>
