...
<Steps>
  <Step title="Go to the Attio Developer Dashboard">
    Navigate to the [Attio developer dashboard](https://build.attio.com/) and sign in.
  </Step>
  ...
  <Step title="Configure OAuth">
    Under **OAuth**, add the Alter callback URL (from the [Developer Portal](https://portal.alterauth.com)) to **Redirect URIs**.
  </Step>
...
- See the [Attio API documentation](https://docs.attio.com/rest-api/tutorials/connect-an-app-through-oauth) for more details on available endpoints.
