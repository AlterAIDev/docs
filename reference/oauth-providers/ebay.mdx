...
<Steps>
  ...
  <Step title="Configure the redirect URI">
    In the application settings, add the Alter callback URL from the [Developer Portal](https://portal.alterauth.com) to the **RuName** (eBay Redirect URL name) configuration.
  </Step>
