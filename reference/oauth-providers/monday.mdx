...
<Steps>
  <Step title="Go to the monday.com Developer Center">
    Open the [monday.com Developer Center](https://developer.monday.com/apps/docs/the-developer-center) by clicking the profile picture in the top-right of monday.com and selecting **Developers**.
  </Step>
  ...
  <Step title="Configure OAuth">
    Under **OAuth**, add the Alter callback URL from the [Developer Portal](https://portal.alterauth.com) to the **Redirect URLs** field.
  </Step>
