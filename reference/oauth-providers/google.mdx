...
<Steps>
  ...
  <Step title="Create OAuth client ID">
    ...
    - **Authorized redirect URIs**: Copy the **Redirect URI** from the [Developer Portal](https://portal.alterauth.com)
    - Click **Create**
  </Step>

  <Step title="Download credentials immediately">
...
<Steps>
  ...
  <Step title="Select scopes">
    Choose the scopes the application needs. See the [Available Scopes](#available-scopes) section below.
  </Step>
...
<Tip>
  Request the minimum scopes the application needs. You can always add more later. Users are more likely to authorize apps that request fewer permissions.
</Tip>
