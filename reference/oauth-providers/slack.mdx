...
<Steps>
  ...
  <Step title="Configure OAuth redirect">
    ...
    - Copy the **Redirect URI** from the [Developer Portal](https://portal.alterauth.com)
    - Click **Save URLs**
  </Step>
  ...
  <Step title="Add bot scopes">
    ...
    - Add the scopes the application needs (see [Available Scopes](#available-scopes) below)
  </Step>
</Steps>
...
| `app_mentions:read` | View messages mentioning the application |
