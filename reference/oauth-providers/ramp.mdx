...
<Steps>
  ...
  <Step title="Contact Ramp to register the application">
  ...
  <Step title="Configure the redirect URI">
    Add the Alter callback URL from the [Developer Portal](https://portal.alterauth.com) to the application's redirect URI configuration.
  </Step>
