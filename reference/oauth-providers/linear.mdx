...
<Steps>
  ...
  <Step title="Add the callback URL">
    Add the **Redirect URI** from the [Developer Portal](https://portal.alterauth.com) to the **Callback URLs** field.
  </Step>
...
- See the [Linear OAuth documentation](https://linear.app/developers/oauth-2-0-authentication) for more details.
