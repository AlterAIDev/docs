...
<Steps>
  ...
  <Step title="Configure the redirect URI">
    Add the Alter callback URL from the [Developer Portal](https://portal.alterauth.com) to the **Redirect URI(s)** field.
  </Step>
...
- See the [Webex integrations documentation](https://developer.webex.com/create/docs/integrations) for more details.
