...
<Note>
  This provider covers **Jira** and **Confluence** via Atlassian's unified OAuth 2.0 (3LO). For Bitbucket, use the dedicated [Bitbucket provider](/reference/oauth-providers/bitbucket).
</Note>
...
<Steps>
  ...
  <Step title="Add the callback URL">
    Under **Authorization**, add the **Redirect URI** from the [Developer Portal](https://portal.alterauth.com) to the **Callback URL** field.
  </Step>
