...
- [`alter managed-secrets`](/reference/cli/commands/managed-secrets) — non-OAuth backend credentials
- [Providers](/concepts/providers), [Connections](/concepts/credentials#oauth-grants)
