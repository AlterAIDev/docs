...
Get started with the Alter SDK for Python to make authenticated API calls to any OAuth provider, manage connections, and create connect sessions. Tokens are retrieved and injected automatically — you never touch them.
