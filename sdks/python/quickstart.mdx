...
Get started with the Alter SDK for Python to make authenticated API calls to any OAuth provider. Tokens are retrieved and injected automatically — you never touch them.
...
Audit logging is always enabled — every token retrieval and API call is automatically logged for compliance and security.
