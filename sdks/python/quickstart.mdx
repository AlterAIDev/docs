...
Tokens are **never exposed** to your code — all internal methods are name-mangled and guarded by frame checks:
...
```
AlterSDKError (base — also raised for input validation: invalid api_key, actor_type, SSRF URL check, missing path_params)
