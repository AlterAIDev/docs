...
The returned SDK instance signs every request with `X-Alter-Scope-Constraints`. No key is minted; the constraint is in-process and disappears with the instance. See [Scopes](/concepts/scopes).
