...
<Steps>
  ...
  <Step title="Create a new app">
    Click **Create App**, select the app type (e.g., **Consumer** or **Business**), and fill in the details.
  </Step>

  <Step title="Add Facebook Login">
    In the app dashboard, click **Add a Product** and set up **Facebook Login**. Under **Facebook Login** > **Settings**, add the Alter callback URL from the [Developer Portal](https://portal.alterai.dev) to **Valid OAuth Redirect URIs**.
  </Step>
