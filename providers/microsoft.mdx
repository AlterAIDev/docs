...
<Steps>
  <Step title="Go to the Azure App Registrations">
    Navigate to the [Azure App Registrations](https://portal.azure.com/#blade/Microsoft_AAD_RegisteredApps/ApplicationsListBlade) and sign in with your Microsoft account.
  </Step>
