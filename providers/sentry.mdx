...
| **Redirect URI** | `https://api.alter.com/oauth/callback` |
...
<Steps>
  ...
  <Step title="Create a new integration">
    ...
    - **Redirect URL**: `https://api.alter.com/oauth/callback`
...
<Steps>
  <Step title="Open the Developer Portal">
    Go to [portal.alter.com](https://portal.alter.com) and navigate to your app.
  </Step>
