...
<Steps>
  ...
  <Step title="Configure the application">
    Enter the application name and company website. Add the Alter callback URL (from the [Developer Portal](https://portal.alterai.dev)) to the **Redirect URI** field.
  </Step>
