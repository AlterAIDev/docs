...
<Steps>
  ...
  <Step title="Configure OAuth 2.0">
    In app settings, under **User authentication settings**, enable **OAuth 2.0**. Set the **Type of App** to **Web App**. Add the Alter callback URL from the [Developer Portal](https://portal.alterai.dev) to the **Callback URI** field.
  </Step>
