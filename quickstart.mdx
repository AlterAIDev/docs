...
For production web apps with a frontend UI, use the session-based flow with Alter Connect.
...
3. **Alter API** -- Handles OAuth and token management (SDKs connect automatically)
