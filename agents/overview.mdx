...
<Note type="warning">
**Agent as principal for OAuth grants.** Today, agents own managed-secret grants directly (phases 1–3 shipped). OAuth grants are owned by users, with agents accessing them via [delegations](/reference/glossary#delegation). A future release will let agents own OAuth grants directly. Tracking in the [SDK_REDESIGN](https://github.com/alter-ai/alter-vault/blob/main/docs/planning/SDK_REDESIGN.md) planning doc.
</Note>
