...
- An IDP configured for that app — see [OAuth → Identity Providers → Overview](/oauth/identity-providers/overview) and the per-IDP guides ([Auth0](/oauth/identity-providers/auth0), [Clerk](/oauth/identity-providers/clerk), [Okta](/oauth/identity-providers/okta), [Keycloak](/oauth/identity-providers/keycloak), [WorkOS](/oauth/identity-providers/workos), [Custom OIDC](/oauth/identity-providers/custom-oidc)).
