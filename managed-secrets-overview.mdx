...
- **[Policy enforcement](/reference/policies)** -- time-based and IP-based access rules, same as OAuth
- **[Full audit trail](/reference/audit-logs)** -- every secret usage logged with actor identity, method, URL, and reason
