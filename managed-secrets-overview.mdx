...
Alter Vault includes pre-configured templates for 30+ services across monitoring, communication, marketing, developer tools, and more. See the [Managed Secret Providers](/managed-secrets/aws) section in the sidebar for the full list and setup guides.
