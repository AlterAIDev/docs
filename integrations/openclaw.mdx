...
<Note>
  The SDK base URL defaults to `https://backend.alterai.dev`. To override (e.g., for staging), set the `ALTER_BASE_URL` environment variable before starting OpenClaw.
</Note>
